...
int main() {
    ...
    data_64_0_addr=virtual_base +( ( unsigned long  )( H2F_SLAVES_ADDR + ONCHIP_MEMORY2_AES_BASE ) & ( unsigned long)( HW_REGS_MASK ) );
	data_64_1_addr=virtual_base +( ( unsigned long  )( H2F_SLAVES_ADDR + ONCHIP_MEMORY2_AES_BASE +8) & ( unsigned long)( HW_REGS_MASK ) );
	

	key_64_0_addr=virtual_base +( ( unsigned long  )( H2F_SLAVES_ADDR + ONCHIP_MEMORY2_AES_BASE +16) & ( unsigned long)( HW_REGS_MASK ) );
    key_64_1_addr=virtual_base +( ( unsigned long  )( H2F_SLAVES_ADDR + ONCHIP_MEMORY2_AES_BASE +24) & ( unsigned long)( HW_REGS_MASK ) );
	

    result_64_0_addr=virtual_base +( ( unsigned long  )( H2F_SLAVES_ADDR + ONCHIP_MEMORY2_AES_BASE +32) & ( unsigned long)( HW_REGS_MASK ) );
    result_64_1_addr=virtual_base +( ( unsigned long  )( H2F_SLAVES_ADDR + ONCHIP_MEMORY2_AES_BASE +40) & ( unsigned long)( HW_REGS_MASK ) );
	
	control_addr=virtual_base +( ( unsigned long  )( H2F_SLAVES_ADDR + ONCHIP_MEMORY2_AES_BASE +48) & ( unsigned long)( HW_REGS_MASK ) );
...
FILE* fPointer2;
   ...
   *(uint64_t *)data_64_1_addr=*(uint64_t *)(&memory[i]);
	...
	printf("hardware decryption time is :%d\n",time(NULL)-begin);
