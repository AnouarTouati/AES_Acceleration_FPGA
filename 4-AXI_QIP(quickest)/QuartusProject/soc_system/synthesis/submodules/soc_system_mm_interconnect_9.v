// soc_system_mm_interconnect_9.v
...
`timescale 1 ps / 1 ps
module soc_system_mm_interconnect_9 (
	...
	soc_system_mm_interconnect_9_router router (
	...
	soc_system_mm_interconnect_9_router_001 router_001 (
	...
	soc_system_mm_interconnect_9_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                           //       clk.clk
		.reset              (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_9_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                                      //       clk.clk
		.reset               (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_9_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                      //       clk.clk
		.reset              (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_9_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                           //       clk.clk
		.reset               (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_9_avalon_st_adapter #(
		.inBitsPerSymbol (258),
		.inUsePackets    (0),
		.inDataWidth     (258),
		.inChannelWidth  (0),
