	soc_system u0 (
		.aescore_to_memory_bridge_external_interface_address     (<connected-to-aescore_to_memory_bridge_external_interface_address>),     // aescore_to_memory_bridge_external_interface.address
		.aescore_to_memory_bridge_external_interface_byte_enable (<connected-to-aescore_to_memory_bridge_external_interface_byte_enable>), //                                            .byte_enable
		.aescore_to_memory_bridge_external_interface_read        (<connected-to-aescore_to_memory_bridge_external_interface_read>),        //                                            .read
		.aescore_to_memory_bridge_external_interface_write       (<connected-to-aescore_to_memory_bridge_external_interface_write>),       //                                            .write
		.aescore_to_memory_bridge_external_interface_write_data  (<connected-to-aescore_to_memory_bridge_external_interface_write_data>),  //                                            .write_data
		.aescore_to_memory_bridge_external_interface_acknowledge (<connected-to-aescore_to_memory_bridge_external_interface_acknowledge>), //                                            .acknowledge
		.aescore_to_memory_bridge_external_interface_read_data   (<connected-to-aescore_to_memory_bridge_external_interface_read_data>),   //                                            .read_data
